        ...
        <div className="p-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <span className="bg-blue-100 text-blue-800 px-4 py-2 rounded-full font-semibold">{property.type}</span>
              {daysOnMarket() <= 7 && (
                <span className="bg-red-100 text-red-800 px-4 py-2 rounded-full font-semibold">🔥 New Listing</span>
              )}
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <button onClick={onClose} className="flex-1 bg-gray-200 text-gray-800 py-3 rounded-lg hover:bg-gray-300 transition font-semibold">
              Close
            </button>
            <button onClick={onInquire} className="flex-1 bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition font-semibold">
              ✉️ Send Inquiry
            </button>
          </div>
        </div>
