  ...
  return (
    <div className="relative w-full">
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-gray-700 hover:bg-gray-600 border border-gray-600 transition-colors"
        ...
        <>
          ...
          <div className="absolute left-0 right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-300 z-50 max-h-[400px] overflow-hidden flex flex-col">
            ...
            <div className="px-3 py-2 border-t border-gray-200 bg-gray-50 flex-shrink-0">
              <p className="text-xs text-gray-600 text-center">💡 Open new tabs to log in as different users</p>
            </div>
          </div>
        </>
      )}
